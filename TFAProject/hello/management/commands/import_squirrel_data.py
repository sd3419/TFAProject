        ...
        with open(options["file_location"]) as file_:
            ...
            for row in reader:
                try:
                    ...
                    a = squirrel_data(row[0],row[1],row[2],row[3],
                                      row[4],datetime.datetime.strptime(row[5], '%m%d%Y').date(),
                                      row[6],row[7],row[8],
                                      row[9],row[10],row[11],
                                      row[12],row[13],row[14],
                                      row[15].capitalize(),row[16].capitalize(),row[17].capitalize(),
                                      row[18].capitalize(),row[19].capitalize(),
                                      row[20], row[21].capitalize(),row[22].capitalize(),
                                      row[23].capitalize(),row[24].capitalize(),
                                      row[25].capitalize(),row[26].capitalize(),
